...
void SessionOrganizer::organizePapers(double timer)
{
    ...
    while(true)
    {
        organizePapersGreedyHillClimbing(timer);
...
void SessionOrganizer::organizePapersGreedyHillClimbing(double timer)
{
...
void SessionOrganizer::organizePapersSimulatedAnnealing(double timer)
{
    ...
    for(int itr = 1; Temperature > 0.009; itr++)
    {
        if(Temperature > 2500)
            Temperature = 5000.0 - itr / 5;
        else if(Temperature > 2)
            Temperature = 3500 - itr / 10;
        else
            Temperature = 35000.0 / itr;
